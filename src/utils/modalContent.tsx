      ...
      return (
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 p-4 rounded-lg">
            <h4 className="font-semibold text-blue-900 mb-2">Exemplos:</h4>
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="bg-purple-50 p-4 rounded-lg">
            <h4 className="font-semibold text-purple-900 mb-2">Interpretação:</h4>
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="bg-indigo-50 p-4 rounded-lg">
            <h4 className="font-semibold text-indigo-900 mb-2">Fórmula:</h4>
            <div className="text-center text-indigo-800 font-mono">
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="bg-teal-50 p-4 rounded-lg">
            <h4 className="font-semibold text-teal-900 mb-2">Fórmula:</h4>
            <div className="text-center text-teal-800 font-mono">
              P(X = k) ≈ e^(-λ) × λ^k / k!
            </div>
      ...
      return (
        <div className="space-y-4">
          ...
          <div className="bg-orange-50 p-4 rounded-lg">
            <h4 className="font-semibold text-orange-900 mb-2">Parâmetros:</h4>
      ...
      return (
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="font-semibold text-gray-900">História (Binomial & Aproximações)</h4>
          </div>
          <div className="space-y-3">
            <div className="border-l-4 border-blue-500 pl-4">
              <p className="font-medium text-blue-900">1713 — Jakob Bernoulli</p>
              <p className="text-blue-800 text-sm">
                <em>Ars Conjectandi</em>: ensaios de Bernoulli (sucesso/fracasso) e fundamentos da binomial.
              </p>
            </div>
            <div className="border-l-4 border-green-500 pl-4">
              <p className="font-medium text-green-900">1733 — Abraham de Moivre</p>
              <p className="text-green-800 text-sm">
                Aproximação normal da binomial para <em>n</em> grande (moedas).
              </p>
            </div>
            <div className="border-l-4 border-purple-500 pl-4">
              <p className="font-medium text-purple-900">1812 — Pierre-Simon Laplace</p>
              <p className="text-purple-800 text-sm">
                Generalização (qualquer <em>p</em>), método de Laplace (CLT/De Moivre–Laplace).
              </p>
            </div>
            <div className="border-l-4 border-teal-500 pl-4">
              <p className="font-medium text-teal-900">1837 — Siméon Denis Poisson</p>
    ...
    case 'manual_calc':
      return (
        <div className="space-y-4">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-blue-600">🧮</span>
            <h4 className="font-semibold text-gray-900">Cálculo Manual Passo-a-Passo</h4>
          </div>
          <div className="space-y-4">
            <div className="bg-gray-50 p-4 rounded-lg">
              <h5 className="font-medium text-gray-900 mb-2">Exemplo: n=5, p=0.3, k=2</h5>
              <p className="text-gray-700 mb-2">Calcular P(X &gt; 2) = P(X=3) + P(X=4) + P(X=5)</p>
    ...
    case 'faq':
      return (
        <div className="space-y-6">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-blue-600">❓</span>
            <h4 className="font-semibold text-gray-900">Perguntas Frequentes</h4>
          </div>

          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4">
              <h5 className="font-medium text-blue-900 mb-2">O que é distribuição binomial?</h5>
              <p className="text-blue-800 text-sm">
            ...
            <div className="border-l-4 border-green-500 pl-4">
              <h5 className="font-medium text-green-900 mb-2">Quando usar a aproximação Poisson?</h5>
              <p className="text-green-800 text-sm">
            ...
            <div className="border-l-4 border-orange-500 pl-4">
              <h5 className="font-medium text-orange-900 mb-2">Quando usar a aproximação Normal?</h5>
            ...
            <div className="border-l-4 border-purple-500 pl-4">
              <h5 className="font-medium text-purple-900 mb-2">O que significa P(X &gt; k)?</h5>
              <p className="text-purple-800 text-sm">
            ...
            <div className="border-l-4 border-red-500 pl-4">
              <h5 className="font-medium text-red-900 mb-2">Por que usar logaritmos nos cálculos?</h5>
            ...
            <div className="border-l-4 border-teal-500 pl-4">
              <h5 className="font-medium text-teal-900 mb-2">Qual a diferença entre média e variância?</h5>
              <p className="text-teal-800 text-sm">
