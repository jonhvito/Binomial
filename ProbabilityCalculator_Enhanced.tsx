...
import { BookOpen, Calculator, HelpCircle, GraduationCap, Compass, Github } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen theme-bg-gradient transition-all duration-300 overflow-x-hidden">
      <div className="w-full max-w-7xl mx-auto px-2 sm:px-4 lg:px-6 xl:px-8 py-4 sm:py-8">
        {/* Header com Toggle de Tema e GitHub */}
        <div className="flex items-start justify-between mb-6 sm:mb-8">
          <div className="flex-1" />
          <div className="flex items-center gap-3">
            <a
              href="https://github.com/jonhvito/Binomial"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center w-10 h-10 bg-gray-200 hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-gray-600 rounded-full transition-colors duration-200 group"
              title="Ver repositório no GitHub"
            >
              <Github className="w-5 h-5 text-gray-700 dark:text-gray-300 group-hover:text-gray-900 dark:group-hover:text-gray-100" />
            </a>
            <ThemeToggle />
          </div>
        </div>
